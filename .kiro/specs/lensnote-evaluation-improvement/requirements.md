...
1. THE MapViewModel SHALL 기간 필터(오늘 / 이번 주 / 이번 달 / 전체)를 지원하는 `DateRangeFilter` 열거형을 정의하며, "오늘"은 당일 00:00:00부터 현재 시각까지, "이번 주"는 직전 월요일 00:00:00부터 현재 시각까지, "이번 달"은 당월 1일 00:00:00부터 현재 시각까지, "전체"는 모든 기간을 의미한다.
